...
class TestStats(unittest.TestCase):
    ...
    def test_add_player(self):
        ...
        self.assertEqual(stats.players, {'Test Player': {'score': 0, 'games_played': 0}})
