...
class TestDifficulty(unittest.TestCase):
    ...
    def test_hard_difficulty(self):
        ...
        self.assertTrue(difficulty.decide_roll_again(10, 50)) # Rolls again if points < 15 and current_player_score + points < 80
        self.assertFalse(difficulty.decide_roll_again(20, 50)) # Doesn't roll again if points >= 15 and current_player_score + points >= 80
